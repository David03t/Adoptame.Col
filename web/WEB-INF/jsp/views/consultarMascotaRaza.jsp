<%-- 
    Document   : consultarMascotaRaza
    Created on : 9/03/2022, 08:40:53 PM
    Author     : DAVID
--%>
...
<html>
    <head>
        ...
        <title>Consulta de Mascota Raza</title>
    </head>
    <body>
                ...
                <form:form commandName="mascotas">
                    <div class="mb-3" style="background: whitesmoke;padding: 20px;">
                        ...
                        <form:label path="raza" cssClass="col-sm-2 col-form-label">Raza:</form:label>
                            <div class="col-sm-10">
                            <form:input path="raza" cssClass="form-control" placeholder="Ingrese la raza"></form:input>
