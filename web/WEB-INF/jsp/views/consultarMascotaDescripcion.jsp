<%-- 
    Document   : consultarMascotaDescripcion
    Created on : 9/03/2022, 08:41:38 PM
    Author     : DAVID
--%>
...
<html>
    <head>
        ...
        <title>Consulta de Mascota Descripcion</title>
    </head>
    <body>
                ...
                <form:form commandName="mascotas">
                    <div class="mb-3" style="background: whitesmoke;padding: 20px;">
                        ...
                        <form:label path="descripcion" cssClass="col-sm-2 col-form-label">Descripcion</form:label>
                            <div class="col-sm-10">
                            <form:input path="descripcion" cssClass="form-control" placeholder="ingrese la descricion"></form:input>
