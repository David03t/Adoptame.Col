<%-- 
    Document   : consultarMascotaCategoria
    Created on : 9/03/2022, 08:40:30 PM
    Author     : DAVID
--%>
...
<html>
    <head>
        ...
        <title>Consulta de Mascota Categoria</title>
    </head>
    <body>
                ...
                <form:form commandName="mascotas">
                    <div class="mb-3" style="background: whitesmoke;padding: 20px;">
                        ...
                        <form:label path="categoria" cssClass="col-sm-2 col-form-label">Categoria:</form:label>
                            <div class="col-sm-10">
                            <form:input path="categoria" cssClass="form-control" placeholder="ingrese la categoria"></form:input>
