                ...
                <table class="formularios table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a  href="updateMascota.htm?id=${mascotas.id}&foto=${mascotas.foto}" class="btn btn-outline-warning">Modificar</a>  <a href="borrarMascota.htm?id=${mascotas.id}&foto=${mascotas.foto}" class="btn btn-outline-danger">Eliminar</a></td>
                      </tr>
                        </c:forEach>
                    </tbody>
                </table>
